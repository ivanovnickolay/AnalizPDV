...
class docFromParamTest extends KernelTestCase
{
	...
	public function dataTest()
	{
		return [
			...
			[["monthCreate"=>1,"yearCreate"=>2016,"numDoc"=>"212//015","typeDoc"=>"ПНЕ","INN"=>"12132121кк"],1],
			[["monthCreate"=>1,"yearCreate"=>2016,"numDoc"=>"212//015","typeDoc"=>"ПНЕ","INN"=>"12132121"],0],
			[["monthCreate"=>1,"yearCreate"=>2016,"numDoc"=>"212//пп","typeDoc"=>"ПНЕ","INN"=>"12132121"],1],
			[["monthCreate"=>1,"yearCreate"=>2016,"numDoc"=>"212//0в","typeDoc"=>"ааа","INN"=>"12132121"],2],
			[["monthCreate"=>1,"yearCreate"=>2016,"numDoc"=>"212//015","typeDoc"=>"ПНЕ","INN"=>"12132121кк"],1],
			[["monthCreate"=>1,"yearCreate"=>2016,"numDoc"=>"212//015","typeDoc"=>"ПНЕ4","INN"=>"+12132121"],2],
			[["monthCreate"=>1,"yearCreate"=>2016,"numDoc"=>"","typeDoc"=>"","INN"=>"///"],3],
			[["monthCreate"=>15,"yearCreate"=>2016,"numDoc"=>"","typeDoc"=>"","INN"=>""],4],
