LOAD DATA LOCAL INFILE 'D:\\OpenServer525\\domains\\AnalizPDV\\web\\Doc\\InvoiceOut\\template_CSV_Out_new(period only 08-16).csv' 
...
;
ALTER TABLE `Erpn_out` COLLATE='utf8_general_ci';